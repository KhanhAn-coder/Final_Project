...
public class ListMouseProduct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listMouseProduct.add(new Product("Chuột máy tính 1",390000,4.6,1.2,R.drawable.mouse_1));
        listMouseProduct.add(new Product("Chuột máy tính 2",279000,4.5,2.5,R.drawable.mouse_2));
        listMouseProduct.add(new Product("Chuột máy tính 3",599000,4.8,1.6,R.drawable.mouse_3));
        listMouseProduct.add(new Product("Chuột máy tính 4",259000,5.0,1.9,R.drawable.mouse_4));
        listMouseProduct.add(new Product("Chuột máy tính 5",490000,4.3,1.8,R.drawable.mouse_5));
        listMouseProduct.add(new Product("Chuột máy tính 6",649000,4.5,2.7,R.drawable.mouse_6));
